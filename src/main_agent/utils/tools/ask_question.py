...
class AskQuestionSchema(BaseModel):
    ...
    3. 向用户确认更多一般性信息
    - question: 您认为您对高等数学“多元微积分”一章的理解如何？
    - option_1: 我完全理解了所有概念，并且可以在各种题目中应用它们
    - option_2: 我理解了大部分概念，但在某些应用上还有疑问，比如如何处理复杂的多变量函数
    - option_3: 我对多元微积分有基本的了解，但题目做的不多，仍有很多不清楚的地方
    - option_4: 我对多元微积分的理解很有限，只知道一些基本概念
    - option_5: 我对多元微积分完全不熟悉，需要从基础开始学习
    """
